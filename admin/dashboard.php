...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-4 col-xl">
        <div class="kpi-card">
            ...
            <div class="kpi-value counter" data-target="<?= $activeMembers ?>"><?= number_format($activeMembers) ?>
            </div>
    ...
    <div class="col-6 col-md-4 col-xl">
        <div class="kpi-card">
            ...
            <div class="kpi-value counter" data-target="<?= $totalCheckIns ?>"><?= number_format($totalCheckIns) ?>
            </div>
        ...
        <div class="glass-panel p-4 h-100">
            ...
            <div class="row text-center mt-3 pt-3 border-top">
                ...
                <div class="col-6">
                    ...
                    <strong
                        class="text-danger font-monospace fs-5"><?= number_format($totalMembers - $activeMembers) ?></strong>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mb-0 fw-bold text-dark">
                                ...
                                <span class="text-secondary small font-monospace ms-2">(No.
                                    <?= htmlspecialchars($act['member_no']) ?>)</span>
                            </h6>
                            <small class="text-muted">Checked in for <strong
                                    class="text-primary"><?= htmlspecialchars($act['title']) ?></strong></small>
                        </div>
                    </div>
